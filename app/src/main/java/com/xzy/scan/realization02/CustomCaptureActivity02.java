 ...
 */
package com.xzy.scan.realization02;
 ...
 */
public class CustomCaptureActivity02 extends CaptureActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        tvTitle.setText(getIntent().getStringExtra(MainActivity02.KEY_TITLE));

        isContinuousScan = getIntent().getBooleanExtra(MainActivity02.KEY_IS_CONTINUOUS,false);
...
//                .framingRectHorizontalOffset(0)//设置识别区域水平方向偏移量，非全屏识别时才有效
    ...
    public boolean onResultCallback(String result) {
        if(isContinuousScan){//连续扫码时，直接弹出结果
            Toast.makeText(this,"11"+result, Toast.LENGTH_SHORT).show();
        }
        return true;
