...
/**
 * 使用库 https://github.com/jenly1314/ZXingLite
 * 扫码Demo示例说明
 *
 * 快速实现扫码有以下几种方式：
 *
 ...
 *
 */
public class MainActivity02 extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            case R.id.btn0:
                ...
                break;
            case R.id.btn1:
                this.cls = CustomCaptureActivity02.class;
                this.title = ((Button)v).getText().toString();
